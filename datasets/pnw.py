...
class PNW(DatasetBase):
    ...
    def _load_meta_data(self,filename="miniPNW_metadata.csv") -> pd.DataFrame:
    ...
    def _load_event_data(self, idx:int) -> Tuple[dict,dict]:
        ...
        path = os.path.join(self._data_dir, f"miniPNW_waveforms.hdf5")
...
class PNW_light(PNW):
    ...
    def _load_meta_data(self,filename="miniPNW_metadata_eq.csv") -> pd.DataFrame:
