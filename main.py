...
def get_args():
    ...
    # Model
    parser.add_argument("--model-name", default="GPT4EQ", type=str, metavar="MODEL_NAME",
                        help="model name: 'GPT4EQ/phasenet/eqtransformer/seist' (default: GPT4EQ)")
    ...
    parser.add_argument("--pretrain", type=bool_, default=True, metavar="PRETRAIN",
                        help="if `True`, GPT2 config is pretrained")
    parser.add_argument("--gpt-layers", type=int, default=6, metavar="GPT_LAYERS",
                        help="if `True`, GPT2 layer")
    parser.add_argument("--bert-layers", type=int, default=6, metavar="BERT_LAYERS",
                        help="if `True`, BERT layer")
    ...
    # Dataset
    parser.add_argument("--data", default="/root/data/Datasets/STEAD", metavar="DATA", type=str,
                        help="path to dataset")
    parser.add_argument("--dataset-name", default="stead", type=str, metavar="DATASET_NAME",
                        help="name of dataset ('stead', 'pnw', or 'pnw_light') (default: 'stead')")
    ...
    parser.add_argument("--few-shot-ratio", type=float, default=1, metavar="FEW_SHOT_RATIO",
                    help="ratio of training data to use for few-shot learning (default: 1)")
